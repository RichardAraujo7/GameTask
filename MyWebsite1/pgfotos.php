...
<html lang="pt-br">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
     ...
     <link href="stylefotos.css" rel="stylesheet" type="text/css"> 
			...
			<div class="infopr"><!-- Região do perfil -->
              ...
              <div style="mt-1">
                <ul class="navigation">
					...
					<li class="l-navigation"><a class="active "  href="pgfotos.php">Fotos</a></li>
				</ul>
             </div>
			</div>
			<div class="conteudoft"> <!-- O que foi selecionado na barra opções -->
				<div class="gallery">
