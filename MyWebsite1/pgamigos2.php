			...
			<div class="infopr"><!-- Região do perfil -->
              ...
              <div style="mt-1">
                <ul class="navigation">
                    ...
                    <li class="l-navigation"><a  class="active " href="pgamigos2.php">Seguindo</a></li>
...
include(conexao.php);
				...
				/*00$query= mysqli_query( $conexao, "SELECT *
                FROM Jogador
                INNER JOIN seguidores ON seguidores.Seguindo= Jogador.codJogador");
            ...
            $query= mysqli_query( $conexao, "SELECT *
                FROM Times
                INNER JOIN seguidores ON seguidores.Seguindo= Times.codTime");
