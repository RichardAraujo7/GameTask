    ...
    <div class="tudope">
			...
			<nav class="navbar fixed-top navbar-expand-lg navbar-light " style="background-color: #87D0FF;">
                <div class="container-fluid">
                    <a class="navbar-brand" href="pgprincipal.php"> <img src="LogoTCCPirocudo.png" width="30" height="30" class="d-inline-block align-top" alt="">
                        Game Task </a>                    
	           ...
	           <div class="partecapa">
                ...
                <div class="menuperfil">
                    <div class="topnav" id="myTopnav">
                        ...
                        <a href="pgperfilft.php" class="active">Fotos</a>
                ...
                <div class= "dirperfilft">
                    <div class="gallery">
                          <a target="_blank" href="ImgGalerias/gameplay1.png">
                            <img src="ImgGalerias/gameplay1.png" alt="Fjords" width="300" height="200">
                          </a>
                    <div class="desc">Add a description of the image here</div>
                    </div>

                    <div class="gallery">
                      <a target="_blank" href="ImgGalerias/gameplay2.png">
                        <img src="ImgGalerias/gameplay2.png" alt="Forest" width="300" height="200">
                      </a>
                      <div class="desc">Add a description of the image here</div>
                    </div>

                    <div class="gallery">
                      <a target="_blank" href="ImgGalerias/gameplay3.png">
                        <img src="ImgGalerias/gameplay3.png" alt="Northern Lights" width="300" height="200">
                      </a>
                      <div class="desc">Add a description of the image here</div>
                    </div>

                    <div class="gallery">
                      <a target="_blank" href="ImgGalerias/gameplay4.png">
                        <img src="ImgGalerias/gameplay4.png" alt="Mountains" width="300" height="200">
                      </a>
                      <div class="desc">Add a description of the image here</div>
                    </div>
            </div>
