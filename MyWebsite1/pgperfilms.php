	           ...
	           <div class="partecapa">
                ...
                <div class="menuperfil">
                    <div class="topnav" id="myTopnav">
                        ...
                        <a href="pgperfilms.php" class="active">Mensagem</a>
                ...
                <div class= "dirperfilms">
                    <div class="form-group" >
                        <form method="post"  enctype="multipart/form-data" action="envia_mensagem.php">

                          <label for="comment">Mande sua mensagem:</label>
                          <textarea class="form-control" rows="5" id="comment" name= "com" style="outline-color: #87D0FF;"></textarea>
                          <input type="submit" class="btn btn-md" style="background-color:#87D0FF; float: right margin-top: 1%;" value="Enviar">
                        </form>
                    </div> 
                </div>
